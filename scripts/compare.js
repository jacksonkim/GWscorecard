        ...
        <div class="metric-values">
            <div class="metric-value hospital-1-value">
                ...
                <div class="metric-value-content">
                    ${isGradeMetric(metric.key)
                        ? `<div class="star-comparison">${renderStars(
                              convertGradeToStars(selectedHospitals.hospital1[metric.key] ?? 0).value
                          )}</div>`
            ...
            <div class="metric-value hospital-2-value">
                ...
                <div class="metric-value-content">
                    ${isGradeMetric(metric.key)
                        ? `<div class="star-comparison">${renderStars(
                              convertGradeToStars(selectedHospitals.hospital2[metric.key] ?? 0).value
                          )}</div>`
